...
const Footer = () => {
  ...
  return (
    <div className="bg-warnaUtama w-full py-6">
      <div className="px-4 w-full max-w-[1024px] mx-auto pb-5 lg:grid lg:grid-cols-2 lg:gap-6 xl:gap-10 lg:items-center lg:justify-center">
        <div>
          <img src={LogoSMP} alt="" className="w-28 lg:w-36" />
          <div>
            <h1 className="text-white font-outfit font-semibold text-base lg:text-xl">
              SMP Muhammadiyah Sumbang
            </h1>
            <p className="text-white font-poppins text-[15px] font-light lg:text-[18px]">
        ...
        <div className="mt-5 grid grid-cols-2 lg:gap-20 xl:gap-32 lg:text-left lg:justify-center lg:flex">
          <div className="flex flex-col gap-2">
            <h1 className="text-white font-poppins text-[20px] lg:text-[22px] font-semibold">
              Navigasi
            </h1>
            <a
              className="text-white font-poppins text-[14px] lg:text-[18px] font-extralight"
              href=""
            >
              Beranda
            </a>
