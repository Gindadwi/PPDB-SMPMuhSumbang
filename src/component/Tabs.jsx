            ...
            <div className='container lg:max-w-[1080px] lg:w-full'>
                ...
                <div className='flex w-full items-center justify-center lg:gap-56'>
                    <button
                        ...
                        className={`py-2 text-sm px-4 font-poppins font-medium ${activeTabs === 'alur' ? 'border-b-4 border-warnaUtama text-warnaUtama' : 'text-black'}`}>
                        Persyaratan & Alur Pendaftaran
                    </button>
                    <button
                        onClick={() => setActiveTabs('informasi')}
                        className={`py-2 px-4 text-sm font-poppins font-medium ${activeTabs === 'informasi' ? 'border-b-4 border-warnaUtama text-warnaUtama' : 'text-black'}`}>
                ...
                <div>
                    {activeTabs === 'alur' && (
                        <div className='space-y-4 text-left lg:px-20 mt-5'>
                            ...
                            <ul className='list-disc pl-5 text-black text-left text-sm lg:text-base font-poppins'>
                ...
                <div>
                    {activeTabs === 'informasi' && (
                        <div className='space-y-4 text-left lg:px-20 mt-5 bg-white p-5 rounded-lg shadow-lg'>
                            {/* Tampilkan informasi yang diambil dari Firebase */}
                            {informasiData.map((item, index) => (
                                <div key={index} className='mt-3'>
                                    <h3 className='font-poppins lg:text-base text-[15px] font-semibold lg:font-semibold'>Informasi PPDB SMP Muhammadiyah Sumbang akan dibuka pada:</h3>
                                    <ul className='list-disc font-poppins mt-1 pl-5 space-y-2 text-sm lg:text-base'>
                            ...
                            <div className='flex w-full gap-5 lg:gap-20'>
                                <Button
                                    name='Daftar'
                                    className={`bg-warnaUtama text-white lg:text-base w-full lg:h-11`}
                                />
                                <Button
                                    name='Check Status'
                                    className={`bg-white text-warnaUtama lg:text-base  border-2 border-warnaUtama rounded-md w-full lg:h-11`}
                                />
                            </div>
